...
export const PaginationTable = ({ columnsHeaders, data }) => {
  ...
  return (
    <div className="border shadow-xl drop-shadow-lg overflow-auto mt-5 ml-2 md:mx-auto w-7/8 lg:w-5/6">
      ...
      <div className="flex margin-auto justify-center gap-2 mt-5 mb-3 items-center">
        <span>
